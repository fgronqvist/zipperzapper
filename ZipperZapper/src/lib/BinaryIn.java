...
/**
 * ****************************************************************************
 * Compilation: javac BinaryIn.java Execution: java BinaryIn input output
 * Dependencies: none
 *
...
public final class BinaryIn {
     ...
     * @return the next {@code r} bits of data from this binary input streamt as
     * a {@code char}
     ...
     * {@code String}
     * @throws NoSuchElementException if this binary input stream is empty or if
     * the number of bits available is not a multiple of 8 (byte-aligned)
     */
     ...
     *
     * @param r number of bits to read
     * @return the next {@code r} bits of data from this binary input stream as
     * a {@code int}
    ...
    /**
     * Unit tests the {@code BinaryIn} data type. Reads the name of a file or
